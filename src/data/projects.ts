...
export const projects: Project[] = [
  ...
  {
    slug: "eventqr",
    title: "EventQR — QR-Based Event Attendance Platform",
    shortDescription:
    ...
    status: "Completed",
    year: "2026",
    startSortDate: "2026-06",
    endSortDate: "2026-06",
    techStack: ["React", "TypeScript", "Node.js", "Express", "PostgreSQL"],
    featured: false,
  },
  {
    slug: "creative-excellence-awards",
    title: "Creative Excellence Awards 2026 — Judging & Voting Platform",
    shortDescription:
    ...
    startSortDate: "2026-06",
    endSortDate: "2026-08",
    techStack: ["React", "TypeScript", "Go", "PostgreSQL", "Docker"],
    featured: false,
  },
];
