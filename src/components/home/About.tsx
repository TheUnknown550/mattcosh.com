    ...
    >
      ...
      <div className="mt-8 flex flex-col gap-10 lg:flex-row lg:items-start lg:justify-between">
        <p className="max-w-2xl text-lg leading-relaxed text-ink-muted">
          ...
          Chiang Mai University, working across full-stack development, IoT, and
          network engineering, with a growing focus on applied AI. My flagship
          project, CS-M, pairs custom heart-sound recording hardware with a
          neural network to flag patterns linked to heart disease — recognized
          by Microsoft Imagine Cup, Intel&rsquo;s AI Global Impact Festival, and
          Regeneron ISEF. I hold a Google Professional Certificate and I&rsquo;m
          looking for software engineering roles where I can keep building
          reliable, practical systems.
        </p>
