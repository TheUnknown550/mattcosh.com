  ...
  return (
    <section className="mx-auto max-w-6xl py-24">
      ...
      <Link
        ...
        className="group mt-10 grid grid-cols-1 gap-10 rounded-lg border border-line bg-surface p-8 transition-all duration-300 hover:-translate-y-1 hover:border-signal hover:shadow-[0_20px_40px_-20px_rgba(45,217,201,0.25)] lg:grid-cols-[1.4fr_1fr] lg:p-12 motion-reduce:transition-colors motion-reduce:hover:translate-y-0"
      >
        <div>
